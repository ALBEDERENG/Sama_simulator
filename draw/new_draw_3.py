#ROTINA QUE PERMITE GERAR GRÁFICO DE % of UE reach Throughtput X BS, THROUGHPUT X BS e gráfico de DENSITY 
    ...
    case 'graph':
                        ...
                        for bs in bs_ue_list:
                                ...
                                for sim in simulation_list:
                                        try:
                                                ...
                                                throughput_values.append(np.mean(cap_array))
                                        except:
                                                pass
        ...
        #====================================== BLOCO SEM MÉDIA ==========================================
            ...
            if config['graph']['graph_type'] == 'density':
                ...
                x_clean = pd.Series(x_data).dropna() #Aqui é a o calculo dos valores para x_data

                sns.kdeplot(
                    x=x_clean, #Passando o resultado dos calculos de x_data para o eixo x do gráfico
                    fill=False,
                    linewidth=2
                )
            ...
            case "y":
                ...
                with open(save_path_csv, mode='w', newline='') as arquivo_csv:
                    ...
                    if config['graph']['graph_type'] == 'density':
                        ...
                        if config['graph']['y_var'] == 'cap' and config['graph']['Throughput'] == 'True':
